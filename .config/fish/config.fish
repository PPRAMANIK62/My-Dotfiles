if status is-interactive
    ...
    set -gx fish_user_paths ~/.local/bin/ /usr/local/lib/nodejs/node-v16.15.1-linux-x64/ /usr/local/lib/nodejs/node-v16.15.1-linux-x64/bin ~/.local/share/nvim/lsp_servers/python/node_modules/.bin ~/.local/share/nvim/lsp_servers/rust ~/.cargo/bin ~/.local/share/nvim/lsp_servers/sumneko_lua/extension/server/bin ~/.cargo/bin 
